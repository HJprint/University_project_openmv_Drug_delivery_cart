...
black_lab2=(0,40,-20,10,-10,20)#黑色终点/数字
...
def num_frist(black_numbers):
    for i in black_numbers:#如果有黑色色块
        ...
        if i.x()>40 and i.x()<280 and abs(i.cx()-160)<90:#放中心才可以识别
            #参数重置
            wh=0;di_chang=0;ding_chang=0;zhong_3=0;zhong_3_xia=0;zhong_6=0
            #1的识别
            wh=i.w()/i.h()
...
while(1):
    ...
    blacks = img.find_blobs([black_lab], pixels_threshold=200, area_threshold=200,merge=True)
